...
void TextureSplatting::onPluginLoad()
{
    ...
    vs->compileSourceFile(glwidget()->getPluginPath()+"/../textureSplatting/textureSplatting.vert");

	// FS
    fs = new QOpenGLShader(QOpenGLShader::Fragment, this);
    fs->compileSourceFile(glwidget()->getPluginPath()+"/../textureSplatting/textureSplatinggg.frag");
